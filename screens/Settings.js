  ...
  return (
    <View className="flex flex-col">
      ...
      <View className="px-2 flex justify-center mt-2 bg-gray-50 mx-2 rounded-xl">
        <View className="flex flex-row items-center justify-start mt-2 ml-2 border-b  py-4 border-gray-200">
        ...
        <View className="flex flex-row items-center justify-start mt-2 ml-2  py-4 ">
